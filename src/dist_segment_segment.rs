...
use crate::{
    dist_point_segment::distance_point_segment, int_segment_segment::intersect_segment_segment,
    point::point, segment::Segment, Point,
};
...
pub fn distance_segment_segment(seg0: Segment, seg1: Segment) -> (f64, Point, Point) {
    ...
    if a > ZERO && c > ZERO {
        ...
        if classify[0] == -1 && classify[1] == -1 {
            ...
            let (param0, param1) =
                compute_minimum_parameters(&edge, &end0, &end1, &b, &c, &e, &g00, &g10, &g01, &g11);
    ...
    let distance = (result0 - result1).norm();
